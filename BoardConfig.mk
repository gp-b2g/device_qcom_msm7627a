...
# Define respective statement to true to enable the ATH or WCN WLAN.
    ...
    ifndef BOARD_HAS_ATH_WLAN
    BOARD_HAS_QCOM_WLAN := true
    endif

    ifeq ($(BOARD_SUPPORT_WAPI),true)
    CONFIG_WAPI=y
    endif
    ...
    WPA_SUPPLICANT_VERSION := VER_2_0_DEV_temp
    HOSTAPD_VERSION := VER_2_0_DEV_temp
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 1435893760
