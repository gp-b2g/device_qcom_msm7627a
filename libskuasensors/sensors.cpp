...
/* The SENSORS Module */
static const struct sensor_t sSensorList_SKUA[] = {
        { "KXTIK 3-axis Accelerometer",
          "ROHM",
          1, SENSORS_ACCELERATION_HANDLE,
          SENSOR_TYPE_ACCELEROMETER, 4.0f*9.81f, (4.0f*9.81f)/1024.0f, 0.2f, 0, { } },
        { "APDS9900 Light sensor",
          "AVAGO",
          1, SENSORS_LIGHT_HANDLE,
          SENSOR_TYPE_LIGHT, 3000.0f, 1.0f, 0.75f, 0, { } },
        { "APDS9900 Proximity sensor",
          "AVAGO",
          1, SENSORS_PROXIMITY_HANDLE,
          SENSOR_TYPE_PROXIMITY, 1.0f, 1.0f, 0.75f, 0, { } },
};
...
{
	/* for other condition */
	*list = sSensorList_SKUA;
	return ARRAY_SIZE(sSensorList_SKUA);
}
...
private:
    ...
    int mWritePipeFd;
    int gsensor_enable_flag;	//add a flag to prevent compass close gsensor
    int mag_enable_gsensor;
...
int sensors_poll_context_t::activate(int handle, int enabled) {
	...
	//LOGE("sensors_poll_context_t::activate index is %d, enabled is %d", handle, enabled);
