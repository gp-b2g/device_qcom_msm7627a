...
include $(CLEAR_VARS)
LOCAL_MODULE       := vold.origin.fstab
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := $(LOCAL_MODULE)
include $(BUILD_PREBUILT)
...
MP_PATH := $(LOCAL_PATH)/../../../../images/UDNCKOLG_FLASH_MT29C4G48MAZAPAKD
